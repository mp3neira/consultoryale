  ...
  <div class="page">
    <div class="gallery">
      ...
      <div class="badge-row">
        ...
        ${c.portas      ? `<div class="badge">${c.portas} portas</div>` : ''}
      </div>
    </div>
    <div class="info">
      ...
      <div class="price-block">
        ...
        <div class="price">${formatarPreco(c.preco)}</div>
      </div>
      <div class="specs">
        <div class="spec"><div class="spec-label">Ano</div><div class="spec-value">${c.ano || '—'}</div></div>
        <div class="spec"><div class="spec-label">Quilometragem</div><div class="spec-value">${formatarKm(c.km)}</div></div>
...
function renderImovel(root, im) {
  ...
  <div class="page">
    ...
    <div class="info">
      ...
      <div class="price-block">
        <div class="price-label">Preço</div>
        <div class="price">${formatarPreco(im.preco)}</div>
      </div>
      <div class="specs">
